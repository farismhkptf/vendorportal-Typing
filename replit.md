...
-   **Wallet Flow**: Vendor wallet uses a ledger system. Topups are positive, debits negative. Balance is the sum of all entries. Deductions happen at approval time (after vendor completes work), NOT at submit time. Balance is checked at submit to ensure sufficient funds.
