...
export function StatTiles({ stats, specialFilter, setSpecialFilter }: StatTilesProps) {
  ...
  const tiles = [
    ...
    { label: "VIP Cases", value: stats.vipCount, icon: Star, color: "text-amber-600 dark:text-amber-400", bg: "bg-amber-50 dark:bg-amber-900/30", filter: "vip" as SpecialFilter },
  ];
  return (
