...
import {
  Search, Shield, Upload, MessageSquare,
...
export default function EidJobs() {
  ...
  const jobs = allJobs?.filter(j => j.jobType?.category === "EID") || [];
    ...
    <div className="p-4 lg:p-6 max-w-6xl">
      ...
      {isLoading ? (
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3" data-testid="section-eid-stats">
            ...
            >
              <CardContent className="p-3 sm:p-4">
                ...
                <p className="text-xl sm:text-2xl font-bold text-foreground" data-testid="text-eid-new-count">{statusCounts.SubmittedToVendor}</p>
            ...
            >
              <CardContent className="p-3 sm:p-4">
                ...
                <p className="text-xl sm:text-2xl font-bold text-foreground" data-testid="text-eid-progress-count">{statusCounts.InProcess}</p>
            ...
            <Card
              ...
              data-testid="tile-eid-completed"
            >
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center gap-2 mb-1.5">
                ...
                <p className="text-xl sm:text-2xl font-bold text-foreground" data-testid="text-eid-completed-count">{statusCounts.Completed}</p>
          ...
          <div>
            <h2 className="text-xs font-medium text-muted-foreground mb-3" data-testid="heading-eid-jobs-list">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            {job.jobType && (
                              <p className="text-xs text-muted-foreground mt-0.5 truncate">
                                {formatJobTypeName(job.jobType.name)}
                              </p>
                            )}
                ...
                <Card>
                  <CardContent className="p-4 sm:p-8">
                    <EmptyState
                      ...
                      description={search ? "Try adjusting your search or filters" : "No Emirates ID jobs assigned yet."}
                    />
                  </CardContent>
                </Card>
              )}
